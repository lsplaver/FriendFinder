...
module.exports = function (app) {
    ...
    app.post("/api/friends", function (req, res) {
        ...
        var determineResults = function () {
            ...
            console.log(tempResults);
            if (z < tempResults.length) {
                console.log("z is: " + z);
                console.log("current length of tempResults before inner if: " + tempResults.length);
                if (tempResults[z].totalDifference < tempResults[z + 1].totalDifference) {
                ...
                else if (tempResults[z].totalDifference > tempResults[z + 1].totalDifference) {
